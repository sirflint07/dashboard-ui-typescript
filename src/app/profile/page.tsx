...
export const metadata: Metadata = {
  title: "User Profile",
  description:
    "View and edit your profile information, including your bio, social links, and profile picture.",
};
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  A versatile professional specializing in Graphic Design, Video Editing, Web Development, and UI/UX Design. I craft compelling designs, engaging videos, dynamic websites, and user-friendly interfaces.
                </p>
              </div>
